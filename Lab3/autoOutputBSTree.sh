...
do
    ...
    echo $SIZE $RUNTIME >> data_output/bstree_output/${STATE}_bstree_data_output_python.dat
    echo $SIZE, $RUNTIME >> data_output/bstree_output/${STATE}_bstree_data_output_python.csv
